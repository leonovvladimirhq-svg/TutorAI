...
PROFILE_BLOCKS: list[ProfileBlock] = [
    ...
    ProfileBlock(
        ...
        description="Нагрузка, работа, обстоятельства, что мешает или помогает учиться.",
        sample_questions=[
            "Есть ли обстоятельства, которые влияют на Вашу учёбу (работа, нагрузка, что-то ещё)?",
        ],
    ),
]
